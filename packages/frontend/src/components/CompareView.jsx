  ...
  return (
    <div className="card pad" style={{ boxShadow: "var(--shadow-soft)" }}>
      ...
      <div className="viz-note" style={{ marginTop: 8 }}>
        {"Δ(B-A) > 0 means this category is stronger in B."}
      </div>
    </div>
  );
}
  ...
  return (
    <div>
      <div className="row" style={{ gap: 12, flexWrap: "wrap", marginBottom: 12 }}>
        <SmallTable title="Outcome category delta summary" rows={strat.ann} />
      </div>

      <div className="row split" style={{ marginBottom: 10, flexWrap: "wrap", gap: 10 }}>
        <div className="pill">Δ(B-A) compare · weight mode: Weight</div>
          ...
          <div className="row split" style={{ marginBottom: 10, flexWrap: "wrap", gap: 10 }}>
            <div className="row" style={{ gap: 8, flexWrap: "wrap" }}>
              ...
              <select
                ...
                title="Show only the strongest Top N nodes (by Σ|Δ|)"
              >
            ...
            <div className="pill">Tip: reduce scale with filters first</div>
          </div>
          <DeltaNetworkView
            diffRows={diff.rows}
            mode={netMode}
